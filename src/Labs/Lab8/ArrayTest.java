...
public class ArrayTest {
    ...
    public void fourthArrayTest() {
        ...
        assertEquals("When checking the fifth element of the fourth array (the 29th line of standard output, we","Jerry",rawOutput[31]);
        assertEquals("When checking the sixth element of the first array (the 30th line of standard output, we","Beth",rawOutput[32]);
